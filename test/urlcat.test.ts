...
describe('urlcat', () => {
  ...
  it('If a parameter appears twice in the path, it is substituted twice', () => {
    ...
    const actual = urlcat('http://example.com/', '/path/:p1/:p2/:p1/r', {
      p1: 'a',
      p2: 'b',
    })
    expect(actual).toBe(expected)
  ...
  it('Throws if a path param is an object', () => {
    expect(() => urlcat('http://example.com/path/:p', { p: {} })).toThrowError(
  ...
  it('Throws if a path param is an array', () => {
    expect(() =>
      urlcat('http://example.com/path/:p/:q', { p: [] }),
    ).toThrowError(
      'Path parameter p cannot be of type object. Allowed types are: boolean, string, number.',
    )
  })
  ...
  it('Throws if a path param is a symbol', () => {
    expect(() =>
      urlcat('http://example.com/path/:p', { p: Symbol() }),
    ).toThrowError(
  ...
  it('Throws if a path param is undefined', () => {
    expect(() =>
      urlcat('http://example.com/path/:p', { p: undefined }),
    ).toThrowError(
  ...
  it('Throws if a path param is null', () => {
    expect(() =>
      urlcat('http://example.com/path/:p', { p: null }),
    ).toThrowError(
      'Path parameter p cannot be of type object. Allowed types are: boolean, string, number.',
    )
  })
  ...
  it('Ignores path params which start with a number', () => {
    expect(
      urlcat('http://example.com:8080/path/:1/:2/:p', { '1': 1, '2': 2, p: 3 }),
    ).toBe('http://example.com:8080/path/:1/:2/3?1=1&2=2')
  })

  it('Does not replace both colons', () => {
    expect(
      urlcat('http::one://example.com:8080/path/:one/:two/:three', {
        one: 1,
        two: 2,
        three: 3,
      }),
